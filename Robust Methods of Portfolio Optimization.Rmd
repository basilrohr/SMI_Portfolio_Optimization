...
To give the final result, the weights in the after shrinkage column from table \@ref(tab:tpwg2rtab) obtain the best future performance for a portfolio including all assets in the Swiss Market Index.
