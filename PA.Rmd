...
kable(gr_mr_vol, col.names = c("Group","Return [%]", "Volatility [%]"), caption = "Mean returns and volatiltiy of groups", digits = 3, booktabs = T, linesep = "")
```

```{r gcm, fig.cap = "Correlation of groups", fig.height = 5}
