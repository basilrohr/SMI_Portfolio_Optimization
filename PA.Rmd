...
# Introduction
The economist Harry Markovitz pioneered modern portfolio theory. In 1952, he developed a mathematical model to calculate efficient portfolios given return and risk of assets.
The disadvantage of this optimization is that the calculations are based on historical data. This data, namely the returns, are strongly affected by noise and therefore will not perform well in future estimations. 
