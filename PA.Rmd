...
The graph \@ref(fig:gg99) shows the tangency portfolio weights of the 20 stocks from the different models. It is clearly visible that certain stocks such as *Julius Baer*, *Givaudan* and *Sika* become very similar weights over the whole period, which is due to lower volatility and a high mean return during this specific time period. Some stocks, such as *Lonza*, have a much higher weighting in Model 3 than in Model 5, which shows that it had a higher mean return in the period of Model 3 than in the rest of the period and therefore was weighted more.
