...
To give the final result, the weights in the after shrinkage column from table \@ref(tab:srcomtab3) obtain the best future performance for a portfolio including all assets in the SMI.
