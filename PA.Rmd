...
**schrittweise erklaeren z.b wie stdm skript seite 70**
...
**Der Grund, warum in-sample besser performt als out-of-sample ist nicht so sehr die Datenmenge, sondern dass das Validation Sample = dem Training Sample ist, also kein unabhängiger Test der Ergebnisse. Man optimiert die past performance über ein Zeitfenster, also kein Wunder dass die past Performance in genau diesem Zeitfenster gut ist.**
...
**Die Erklärung, warum das out-of-sample Sharpe besser ist wenn man weniger optimiert, sollte noch verbessert werden (optimizing 20 parameters leads to portfolios that perform well in-sample, but that are poorly diversified and therefore tend to perform poorly out-of-sample)**
