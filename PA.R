...
gg4 = ggplot() + geom_line(aes(x = seq(0, 1, 0.01), y = out4[1,])) + expand_limits(y = 0)
gg5 = ggplot() + geom_line(aes(x = seq(0, 1, 0.01), y = out5[1,])) + expand_limits(y = 0)
ggarrange(gg1, gg2, gg3, gg4, gg5)
...
# Cov mat inv
m1 = solve(out_of_sample(sets_r, set = 1)$shrinking_cov_mat)
m2 = solve(out_of_sample(sets_r, set = 2)$shrinking_cov_mat)
